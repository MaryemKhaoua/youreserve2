...
public class configConx {
    private static configConx instance;
    private Connection connection;

    // Constructeur privé pour Singleton
    private configConx() throws SQLException {
    ...
    public static configConx getInstance() throws SQLException {
        if (instance == null) {
            instance = new configConx();
